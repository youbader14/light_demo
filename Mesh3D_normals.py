...
class Mesh3D:
    ...
    def get_vao(vertices, faces, texture, usage="GL_STATIC_DRAW"):
        ...
        #####################################################
        # adjusted the stride lenth to acomodate the additional vertex
        # now it has 24 bytes if there is no texture; else it has 32
        ...
        ########################################################
        # Added a new vertex attribute for the normal components
